...
\begin{frame}{Intra-Building Trades: Interviews}
	\begin{itemize}
		\item Largely do not support hypothesis
		...
		\item Building Trades often use this approach for service-based employers or where employers have a permanent workforce — usually not construction work.
