...
\textbf{Do unions with petrochemical work align themselves with the petrochemical industry?}\newline
...
\emph{Not necessarily.}
	...
	\end{itemize}
The UA does use pre-hire agreements, while the OCAW/USW does not.
\end{frame}
...
\begin{itemize}
	...
	\begin{itemize}
  	...
  	\begin{itemize}
  		...
  		\item Supports a move away from dirty energy.
  	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Pre-hire agreements.
		\item No Building Trades unions are listed as Labor for Single-Payer Healthcare supporters.
	\end{itemize}
  	\item The Machnists.
  	\begin{itemize}
  		\item Organizes workers at the workplace.
  		\item Listed as a Labor for Single-Payer Healthcare supporter.
  	\end{itemize}
\end{itemize}
\end{frame}
