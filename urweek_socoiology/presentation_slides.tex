...
\textbf{Do craft unions that organize the industrial path support more progressive policies?}
	\begin{itemize}
...
\subsection{Machinists (IAM) and Longshore Workers: Inter-union conflicts}
\begin{frame}{Findings: Inter-union conflicts}
	\begin{itemize}
