...
\begin{frame}{Case Selection}
	\begin{itemize}
			\item \textbf{UA}\footnote{Schneirov, Richard. 1993. \textit{Pride and Solidarity: A History of the Plumbers and Pipefitters of Columbus, Ohio, 1889-1989}. Ithaca, N.Y: ILR Press.}: United Association of Plumbers and Pipefitters Local 189
			\item \textbf{OCAW/USW}\footnote{Leopold, Les. 2007. \textit{The Man Who Hated Work and Loved Labor}. White River Junction, Vt: Chelsea Green Pub. Company.
}: Oil Chemical and Atomic Workers Union (now part of the United Steelworkers)
			\item \textbf{IAM}\footnote{McCann, John. 1989. \textit{Blood in the Water: A History of District Lodge 751, International Association of Machinists and Aerospace Workers}. Olympia, Washington: District Lodge 751, IAM\&AW.}: International Association of Machinists
	\end{itemize}
\end{frame}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_2}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_3}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_4}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_5}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_7}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_8}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_9}
...
\begin{frame}{Union Organizing Paths: Comparison}
  \begin{columns}
    \column{0.6\textwidth}
    \includegraphics[scale=0.15]{../images/organizing_paths_10}
