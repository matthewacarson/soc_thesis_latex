...
%\part{INTRODUCTION} \
\addcontentsline{toc}{part}{INTRODUCTION}\label{introduction}
...
\noindent{}However, this also does not represent much of a difference from what other building trades unions support. That notwithstanding, the IBEW local \emph{does} seem to be more politically active than the Millwrights local.
