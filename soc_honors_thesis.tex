...
\titleformat{\part}[display]{\normalfont\Large\bfseries}{\partname\ \thepart}{20pt}{\Large}
...
\part{CRAFT UNIONISM VS. INDUSTRIAL UNIONISM}\label{sec:craft_vs_industrial} \
...
\section{The Building Trades Approach}\label{sub:bt_bargaining}\
