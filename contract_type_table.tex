...
\begin{center}\begin{flushleft}Employer \textit{has an obligation} to continue bargaining after the contract expires\end{flushleft}\end{center} & % Col 2
\begin{center}\begin{flushleft}Employer has \textit{no obligation} tocontinue bargaining after the contract expires\end{flushleft}\end{center} \\	% Col 3
\midrule
...
% Row
\begin{center} \textbf{Majority Status} \end{center} &	% Col 1
\begin{center}\begin{flushleft} Required \end{flushleft}\end{center} &	% Col 2
\begin{center}\begin{flushleft} \textit{Not} Required \end{flushleft}\end{center} \\ % Col 3
\midrule
\bottomrule
